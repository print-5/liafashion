...
const ProductCard = ({ product }) => {
  ...
  const originalPrice = defaultSize.mrp || 0
  const discountedPrice = defaultSize.price || originalPrice
  const discount = originalPrice ? Math.round(((originalPrice - discountedPrice) / originalPrice) * 100) : 0
      ...
      <div className="relative overflow-hidden mb-3">
        ...
        {badge && (
          <span 
            ...
            style={{
              background:
                badge === "New arrival" ? "#e6f9ec" :
                badge === "Best Seller" ? "#e6f0fa" :
                badge === "Hot Selling" ? "#fff4e6" :
                badge === "Trending" ? "#f3e6fa" :
                badge === "Limited" ? "#fae6e6" :
                badge === "Premium" ? "#fffbe6" : "#f3f4f6",
              color:
                badge === "New arrival" ? "#1db954" :
                badge === "Best Seller" ? "#2563eb" :
                badge === "Hot Selling" ? "#f97316" :
                badge === "Trending" ? "#a21caf" :
                badge === "Limited" ? "#dc2626" :
                badge === "Premium" ? "#eab308" : "#374151"
            }}
          >
            {badge}
          </span>
