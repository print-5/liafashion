import ProductCard from "./PremiumSectionProductCard"
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const premiumProducts = list
          .filter(product => product.badge === 'Premium')
          .sort((a, b) => b.id - a.id)
          .slice(0, 4)
    ...
    return (
      <section className="py-6 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-2">Premium</h2>
