import ProductCard from "./NewArrivalProductCard"
    ...
    return (
      <section className="py-12 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-2">New Arrivals</h2>
  ...
  return (
    <section className="py-12 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
      ...
      <div className="text-center mt-10">
        <Link href="/products?collection=New%20arrival">
